...
import org.apache.shiro.jakarta.env.EnvironmentLoaderListener;
...
class WebGuiceEnvironment implements WebEnvironment {
    ...
    @Inject
    WebGuiceEnvironment(FilterChainResolver filterChainResolver, @Named(NAME) ServletContext servletContext, WebSecurityManager securityManager) {
