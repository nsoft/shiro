...
import org.apache.shiro.jakarta.filter.PathMatchingFilter;
import org.apache.shiro.jakarta.filter.authc.*;
import org.apache.shiro.jakarta.filter.authz.*;
import org.apache.shiro.jakarta.filter.mgt.FilterChainResolver;
import org.apache.shiro.jakarta.filter.session.NoSessionCreationFilter;
 ...
 * {@link WebSecurityManager}, {@link SecurityManager} and {@link SessionManager}.  At least one realm must be added by
 * using {@link #bindRealm() bindRealm}.
 * <p/>
 * Also provides for the configuring of filter chains and binds a {@link FilterChainResolver} with that information.
 */
public abstract class ShiroWebModule extends ShiroModule {
     ...
     * <p/>
     * By default, a {@link DefaultWebSecurityManager} is bound as an eager singleton.
     *
     * @param bind
     */
     ...
     * <p/>
     * NOTE: If the provided key is for a subclass of {@link PathMatchingFilter}, it will be registered with a proper
     * provider.
     *
     * @param pattern
     * @param keys
