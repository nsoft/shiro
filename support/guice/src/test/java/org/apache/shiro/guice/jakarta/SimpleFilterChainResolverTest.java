...
public class SimpleFilterChainResolverTest {
    ...
    public void testGetChain() throws Exception {
        ...
        org.apache.shiro.guice.jakarta.SimpleFilterChainResolver underTest = new org.apache.shiro.guice.jakarta.SimpleFilterChainResolver(chainMap, injector, patternMatcher);
