...
public class SimpleFilterChainTest {
    ...
    public void testDoFilter() throws Exception {
        ...
        org.apache.shiro.guice.jakarta.SimpleFilterChain underTest = new org.apache.shiro.guice.jakarta.SimpleFilterChain(originalChain, Arrays.asList(filter1, filter2).iterator());
