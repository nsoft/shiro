...
import org.apache.shiro.jakarta.servlet.Cookie;
...
public class SimpleCookieTest extends TestCase {
    ...
    public void testReadValueInvalidPath() throws Exception {
        ...
        expect(mockRequest.getCookies()).andStubReturn(new jakarta.servlet.http.Cookie[] { new jakarta.servlet.http.Cookie(this.cookie.getName(), "value") });
        replay(mockRequest);
        replay(mockResponse);
    ...
    private static <T extends jakarta.servlet.http.Cookie> T eqCookie(final T in) {
        reportMatcher(new IArgumentMatcher() {
            public boolean matches(Object o) {
                jakarta.servlet.http.Cookie c = (jakarta.servlet.http.Cookie) o;
